  ...
  return (
    <>
      ...
      <div className="w-screen p-24 flex flex-col items-center gap-3 fixed top-0 left-0 overflow-y-auto z-20">
        <UserBadge user={user} />
        <Heading size="8">Getting started</Heading>
...
function Create({ router }: { router: any }) {
  const cw = () => {
    const elm: HTMLInputElement | null = document.getElementById(
      "workspaceName",
    ) as HTMLInputElement;
    if (!elm) {
      return undefined;
  ...
  return (
    ...
    >
      ...
      <Dialog.Description size="2" color="gray" mb="5">
        Workspaces are containers for your models, functions, databases,

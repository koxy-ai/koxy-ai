          ...
          <div className="pt-14">
            <div className="p-5">
              <Text color="gray" className="flex gap-2 items-center">
                You can not create more than {flows.length} flows in the{" "}
                {workspace.plan} plan.
                <Link
                  href={`/workspace/${workspace.id}/flows`}
                  className="text-power"
                >
                  Go back
                </Link>
              </Text>
            ...
            <div className="border-1 border-border/90 rounded-lg bg-accent/10 max-w-[50%] min-w-[50%]">
              <div className="p-5 flex flex-col gap-1">
                ...
                <Text size="2" color="gray">
                  Your flow will have its own API routes, nodes map,
                  deployments, docs, domains, and analytics.
                </Text>
              </div>
              <div className="p-5 border-t-1 border-border/50 flex flex-col gap-1">
                <Text size="3">Flow name</Text>
                <Text size="2" color="gray" mb="3">
                  Globally unique, Can be changed later. leave empty to generate
                  random.
                </Text>
                <Input
              ...
              <div className="p-5 border-t-1 border-border/50 flex flex-col gap-3">
                ...
                <div className="flex items-center gap-2">
                  <Text size="2" color="gray">
                    First deployment will be pushed as{" "}

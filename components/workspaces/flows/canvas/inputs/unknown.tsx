...
export default function Unknown({ param, type, setType, continueAsType }: UnknownParams) {

    return (
        <div className="flex flex-col gap-2 h-[100%]">
            <Badge color={inputTypes[param.type] as any} className="max-w-max">unknown</Badge>
            <Text size="2" mb="2">
                Unknown input type
            </Text>
            <Text size="2" mb="4" color="gray" className="w-full max-w-[90%]">
                When the type is unknown, the input will be treated based on the <b>type you set</b>.
                It can be changed later, and it effects how the input is treated and displayed.
            </Text>

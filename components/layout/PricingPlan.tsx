...
const storage_features = ["50GB of storage space", "50MB max file size"];
...
const cron_features = ["4 Cron jobs"];
    ...
    <div className="innerMain p-14 flex flex-col gap-3 items-center">
      <div className="flex flex-col items-center justify-center gap-3 mb-4">
        <div className="flex flex-col items-center justify-center gap-2">
          <Heading align="center" size="8" className="textGradient">
            Upgrade your workspace now <Icon id="sparkles" size="larger" />
          </Heading>
        </div>
        <Text color="gray" align="center">
          {mainFeature} are only supported in the Pro plan.{" "}
      ...
      <div className="planContainer">
        <div className="flex items-center w-full sm:flex-col sm:items-start md:items-center md:flex-row">
          <div className="min-w-max flex flex-col gap-4">
            <Badge variant="surface" style={{ maxWidth: "max-content" }}>
              pro plan
            </Badge>
            <Heading>
              {type === "monthly" ? "$19 / month" : "$160 / year (30% off)"}
            </Heading>
          </div>
          <div className="flex w-full items-center sm:mt-2 md:mt-0 md:justify-end">
            <button className="powerButton">Choose plan</button>
          </div>
        </div>

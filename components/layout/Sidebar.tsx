                ...
                <Dialog.Trigger>
                    <div className="w-full min-h-[3.3rem] border-b-1 border-[var(--gray-a4)] flex items-center group pl-4 pr-4 text-xs transition-all">
                        <button className="sidebarButton hover:bg-transparent group truncate">
                            <div
                                className="w-full flex items-center gap-1 min-w-max"
                            >
                                <div
                                    className="w-6 h-6 border-1 border-[var(--gray-a9)] rounded-md mr-1 flex items-center justify-center bg-black"
                                >
                                    <Icon id="box" />
                                </div>
            ...
            <div className="flex flex-col p-3 pb-1 gap-3">
                ...
                {workspaces.map(item => (
                    ...
                    >
                        ...
                        {item.name}
                        {workspace.id === item.id ? <Badge color="gray">current</Badge> : null}
                    </div>
                ))}
            </div>

            <div className="flex flex-col p-3 gap-3 mt-2">
                <Text style={{filter: "opacity(.75)"}} size="1" color="gray">Actions</Text>
                {actions.map(action => (
                    <div
                    ...
                    >
                        ...
                        <div className="w-full flex items-center justify-end opacity-80">
                            <Badge color="gray" variant="surface">{action.shortcut}</Badge>
                        </div>
                    </div>
                ))}
                ...
                <Dialog.Close>
                    ...
                    >
                        ...
                        <div className="w-full flex items-center justify-end opacity-80">
                            <Badge color="gray" variant="surface">esc</Badge>
                        </div>
                    </div>
                </Dialog.Close>
            </div>

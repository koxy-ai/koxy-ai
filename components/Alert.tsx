...
export default function Alert() {
	...
	return (
		<div>
			<div id="errorAlertContainer" className="errorContainer translate-y-[110%] opacity-0">
				<Heading size="2" mb="2">Something went wrong</Heading>
				<p id="errorAlertText" className="text-xs text-gray-300"></p>
			</div>
			<div id="successAlertContainer" className="successContainer translate-y-[110%] opacity-0">
				<Heading size="2" mb="2">Something went wrong</Heading>
